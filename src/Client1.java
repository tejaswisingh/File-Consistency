...
public class Client1 extends JFrame
{
	...
	public Client1(){										//it runs the constructor and enables all gui properties														
	...
	public static void sendMsg()  throws UnknownHostException, IOException {
		File clientfile = new File("C:/Users/tejas/Desktop/Client1/test.txt");
		...
		while(true) {
			...
			if(time1 != time2) {
				File source = new File("C:/Users/tejas/Desktop/Client1/test.txt");
	...
	{	
		new Client1();//Object is called on 
																		//creates new file
